...
## 調査報告 (2026-05-16 05:40)
- モデル名: Smart Resize (fal-ai/smart-resize)
- server_name: i2i-kamui-smart-resize
- 推測される開発元: fal.ai
- 調査で確認した情報源:
  - fal.aiブログの複数の記事（2025年11月〜2026年5月）にて動的ウィジェットの「new」リストとして表示されている。
  - 2025年12月23日更新のGitHubリポジトリ（fal-mcp-server）にて「resize_image」の記載あり。
- 不明な理由: fal.aiの公式X（Twitter）アカウント、公式ブログのアナウンス記事、またはChangelogに当該エンドポイントの明確な公開日の記述が確認できなかったため。
---
## 調査報告 (2026-04-29 05:43)
